...
import com.cctv.project.noah.system.generator.service.IGenTableColumnService;
import com.cctv.project.noah.system.generator.service.IGenTableService;
import com.cctv.project.noah.system.util.security.PermissionUtils;
...
public class GenController extends BaseController {
    private String prefix = "system/gen";
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"noah.zip\"");
